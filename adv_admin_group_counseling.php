...
if (isset($_POST['add_group'])) {
    ...
    $sql = "INSERT INTO adv_group_counselings (details, doctor_name, start_time, end_time, link) VALUES ('$details', '$doctor_name', '$start_time', '$end_time', '$link')";
    $conn->query($sql);
}
?>
...
<head>
    ...
    <title>Admin Advanced Group Counseling</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <span>Admin Advanced Group Counseling</span>
        <ul>
            <li><a href="admin_dashboard.php">Home</a></li>
            <li><a href="adv_admin_counseling.php">Advanced Counseling</a></li>
            <li><a href="admin_logout.php">Logout</a></li>
        </ul>
    </div>

    <div class="container">
        <h2>Manage Advanced Group Counseling</h2>
        ...
        <div class="section-content">
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM adv_group_counselings WHERE end_time > '$now'";
