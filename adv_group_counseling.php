...
<head>
    ...
    <title>Advanced Group Counseling</title>
    <style>
        body {
...
<body>
    ...
    <div class="navbar">
        <span>Advanced Group Counseling</span>
        <ul>
            <li><a href="parent_home.php">Home</a></li>
            <li><a href="specialchild.php">Special Child Home</a></li>
            <li><a href="adv_counseling.php">Advanced Counseling</a></li>
            <li><a href="parent_logout.php">Logout</a></li>
        </ul>
    </div>

    <div class="container">
        <h2>Advanced Group Counseling Sessions</h2>
